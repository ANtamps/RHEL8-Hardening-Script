...
touch chapter5-audit-error.log
...
let COUNTER++
    ...
    echo -e "Permissions on etc/crontab not configured: \033[1;31mERROR\033[0m"
		echo -e "Permissions on etc/crontab not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
    ...
    echo -e "Permissions on /etc/cron.hourly not configured: \033[1;31mERROR\033[0m"
		echo -e "Permissions on /etc/cron.hourly not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "Permissions on /etc/cron.daily not configured: \033[1;31mERROR\033[0m"
		echo -e "Permissions on /etc/cron.daily not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
    ...
    echo -e "Permissions on /etc/cron.weekly not configured: \033[1;31mERROR\033[0m"
		echo -e "Permissions on /etc/cron.weekly not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
    ...
    echo -e "Permissions on /etc/cron.monthly not configured: \033[1;31mERROR\033[0m"
		 echo -e "Permissions on /etc/cron.monthly not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
    ...
    echo -e "Permissions on /etc/cron.d not configured: \033[1;31mERROR\033[0m"
		echo -e "Permissions on /etc/cron.d not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi

##5.1.8 Ensure cron is restricted to authorized users
if rpm -q cronie >/dev/null; then
    echo -e "cron still installed: \033[1;31mERROR\033[0m"
		echo -e "cron still installed: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
else
...
if rpm -q at >/dev/null; then
  echo -e "at still installed: \033[1;31mERROR\033[0m"
	echo -e "at still installed: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
        ...
        echo -e "Permissions not set to read-only for root: \033[1;31mERROR\033[0m"
				echo -e "Permissions not set to read-only for root: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
    fi
else
    echo -e "File not owned by root: \033[1;31mERROR\033[0m"
		echo -e "File not owned by root: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
        ...
        echo -e "$(stat -c %n $file) has permissions and/or ownership/group conflict: \033[1;31mERROR\033[0m"
				echo -e "$(stat -c %n $file) has permissions and/or ownership/group conflict: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
    fi
done
...
let COUNTER++
        ...
        echo -e "File permission for $(stat -c %n $file) not set to 600: \033[1;31mERROR\033[0m"
				echo -e "File permission for $(stat -c %n $file) not set to 600: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
    fi
done
...
let COUNTER++
    ...
    echo -e "SSH LogLevel not set to appropriate: \033[1;31mERROR\033[0m"
		echo -e "SSH LogLevel not set to appropriate: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH PAM is not enabled: \033[1;31mERROR\033[0m"
		echo -e "SSH PAM is not enabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH root login is not enabled: \033[1;31mERROR\033[0m"
		echo -e "SSH root login is not enabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH HostbasedAuthentication is not disabled: \033[1;31mERROR\033[0m"
		echo -e "SSH HostbasedAuthentication is not disabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi 
...
let COUNTER++
    ...
    echo -e "SSH PermitEmptyPasswords is not disabled: \033[1;31mERROR\033[0m"
		echo -e "SSH PermitEmptyPasswords is not disabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH PermitUserEnvironment is not disabled: \033[1;31mERROR\033[0m"
		echo -e "SSH PermitUserEnvironment is not disabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH IgnoreRhosts is not enabled: \033[1;31mERROR\033[0m"
		echo -e "SSH IgnoreRhosts is not enabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH X11 forwarding is not disabled: \033[1;31mERROR\033[0m"
		echo -e "SSH X11 forwarding is not disabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH AllowTcpForwarding is not disabled: \033[1;31mERROR\033[0m"
		echo -e "SSH AllowTcpForwarding is not disabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "System-wide crypto policy is over-ridden: \033[1;31mERROR\033[0m"
		echo -e "System-wide crypto policy is over-ridden: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH warning banner is not enabled: \033[1;31mERROR\033[0m"
		cho -e "SSH warning banner is not enabled: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH MaxAuthTries not set to 4 or less: \033[1;31mERROR\033[0m"
		echo -e "SSH MaxAuthTries not set to 4 or less: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH MaxStartups is not configured: \033[1;31mERROR\033[0m"
		echo -e "SSH MaxStartups is not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH MaxSessions not set to 10 or less: \033[1;31mERROR\033[0m"
		echo -e "SSH MaxSessions not set to 10 or less: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH LoginGraceTime not set to 1 minute or less: \033[1;31mERROR\033[0m"
		echo -e "SSH LoginGraceTime not set to 1 minute or less: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
    ...
    echo -e "SSH Idle Timeout Interval is not configured: \033[1;31mERROR\033[0m"
		echo -e "SSH Idle Timeout Interval is not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
  ...
  echo -e "sudo not installed: \033[1;31mERROR\033[0m"
	echo -e "sudo not installed: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
let COUNTER++
  ...
  echo -e "sudo commands does not use pty: \033[1;31mERROR\033[0m"
	echo -e "sudo commands does not use pty: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "sudo log file does not exist: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "NOPASSWD does exist: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "!authenticate does exist: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e  "authentication timeout is not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "empty group not found: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
	...
	echo -e "Authselect does not includes with-faillock: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "Password creation requirements are not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
let COUNTER++
	...
	echo -e "Lockout for failed password attempts is not configured: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Hashing algorithm is not sha512 in /etc/libuser.conf: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "Hashing algorithm is not sha512 in /etc/login.defs: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Password expiration is not set to 365 days: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Minimum days between password changes is not set to 7: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Password expiration warning days is not set to 7: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Inactive password lock is not set to 30 days: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Some users last password change date is in the future: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Default user shell timeout is not set to 900 seconds in /etc/profile: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "Default user shell timeout is not set to 900 seconds in /etc/bashrc: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
...
echo -e "Default group for the root account is not GID 0: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
fi
...
echo -e "Default user mask is not 027: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
	fi
else
echo -e "Default user mask is not 027: \033[1;31mERROR\033[0m"
echo -e "Default user mask is not 027: \033[1;31mERROR\033[0m" >> chapter5-audit-error.log
